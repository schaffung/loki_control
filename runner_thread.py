...
import importlib
import argparse
from operation_libs.framework_mixin import framework_mixin
...
if __name__ == "__main__":
    ...
    parser.add_argument('-l', '--log_path', dest='log_path', help="Logfile path",
                        default="/tmp/framework.log", type=str)
    ...
    fre_mixin = framework_mixin(args.conf_path)
    fre_mixin.set_logging_options(args.log_path, args.log_level)
    fre_mixin.establish_connection()
    ...
    test_object = test_class(fre_mixin) 
